...
export const siteConfig = {
  ...
  /**
   * The support mailbox, confirmed by the owner as the .shop domain — matching
   * PRIMARY_DOMAIN, so the address a buyer sees agrees with the site they are
   * buying from. This is the single source: every policy page, the footer, the
   * FAQ, the checkout trust block and the thank-you page read from here, so
  ...
  /** OG card is generated by src/app/opengraph-image.tsx — no static file to keep in sync. */
